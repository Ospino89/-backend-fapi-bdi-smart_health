...
def parse_arguments():
    ...
    parser.add_argument(
        '--sql-dir',
        required=True,
        help='Directory containing SQL files (e.g., ../ddl)'
    )
    parser.add_argument(
        '--user',
        required=True,
    ...
    parser.add_argument(
        '--database',
        default='smarthdb',
        help='Target database name (default: smarthdb)'
    )
    parser.add_argument(
        '--create-script',
        default=False,
        help='Create database if its necessary.'
    )
...
def parse_sql_file(filepath):
    ...
    Se fuerza UTF-8 y, si hay problema de codificación, se usa latin-1
    sin cambiar nada más de la lógica.
    """
    try:
